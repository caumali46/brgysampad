 ...
 //   include "pages/connection.php";
    ...
    if (!$con) {
      ...
      if (isset($_POST['btn_login'])) {
        ...
        exit;
        // echo '<script type="text/javascript">location.replace("https://brgysampad.com/pages/officials/officials.php"); </script>';
        } 
        elseif ($numrow_zone > 0) {
          ...
          while ($row = mysqli_fetch_array($zone)) {
           ...
           header("Location: https://brgysampad.com/pages/permit/permit.php");
        //   ob_end_flush();
           exit();
        } else {

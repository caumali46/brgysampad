    ...
    <form method="post" enctype="multipart/form-data">
      <div class="container">
        <div class="row title" style="text-align: center;">
          <h1>APPLICATION FOR BARANGAY CLEARANCE</h1>
        </div>
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-warning">
              ...
              <div class="form-group">
                ...
                <input name="txt_purpose" class="form-control input-sm input-size" type="text" placeholder="" />
              </div>
            </div><!-- /.box -->
          </div>
          <!--/.col (right) -->
      ...
      <div class="container">
        <div class="row" style="text-align: center; margin-top:1em">
          <div class="offset-7 col-md-6">
            ...
            <input type="submit" class="btn btn-primary btn-md" name="btn_add" id="btn_add" value="Add Resident" required />
          </div>
        </div>
      </div>
    </form>

        ...
        <div class="modal-dialog modal-sm" style="width:300px !important;">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="txt_hof" id="txt_hof" class="form-control input-sm" placeholder="Full Name" type="text" />
                            </div>
                            <div class="form-group">
                                <label>Total Number of Members:</label>
                                <input id="txt_totalmembers" name="txt_totalmembers" class="form-control input-sm" type="text" placeholder="Total Number of Members" required />
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary btn-sm" name="btn_add" value="Add Household" required />
                </div>
            </div>
        </div>
    </form>

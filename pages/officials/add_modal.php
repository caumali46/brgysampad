<!-- ========================= MODAL ======================= -->
<div id="addCourseModal" class="modal fade" action="function.php">
  <form method="post">
    <div class="modal-dialog modal-sm" style="width:300px !important;">
      <div class="modal-content">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <select name="ddl_pos" class="form-control input-sm" required>
                  ...
                  <option value="Kagawad(Ordinance)">Barangay Kagawad(Sports, Senior Citezen & Disaster Preparedness)</option>
                  <option value="Kagawad(Public Safety)">Barangay Kagawad( Peace & Order and Public Safety)</option>
                  <option value="Kagawad(Tourism)">Barangay Kagawad(Environment & Waste Mngt.)</option>
                  <option value="Kagawad(Budget & Finance)">Barangay Kagawad(Budget & Finance)</option>
                  <option value="Kagawad(Agriculture)">Barangay Kagawad(Agriculture & Livehood Devt.)</option>
                  <option value="Kagawad(Education)">Barangay Kagawad(Health & Education)</option>
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-primary btn-sm" name="btn_add" value="Add Officials" required />
        </div>
      </div>
    </div>
  </form>

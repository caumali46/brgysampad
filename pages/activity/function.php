...
if (isset($_POST['btn_add'])) {
    ...
    //if($num_rows == 0){
    $query = mysqli_query($con, "INSERT INTO tblactivity (dateofactivity,activity,description,created_at) 
            values ('$txt_doc', '$txt_act', '$txt_desc','$created_at')") or die('Error: ' . mysqli_error($con));

        ...
        <div class="modal-dialog modal-sm" style="width:300px !important;">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!-- <div class="form-group">
                                    ...
                                    <input name="files[]" class="form-control input-sm" type="file" multiple required/>
                                </div> -->
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary btn-sm" name="btn_add" value="Add Activity" required />
                </div>
            </div>
        </div>
    </form>

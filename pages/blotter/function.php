...
if (isset($_POST['btn_save'])) {
    ...
    $txt_edit_witness = $_POST['txt_edit_witness'];
    ...
    $update_query = mysqli_query($con, "UPDATE tblblotter set complainant = '" . $txt_edit_cname . "', cage = '" . $txt_edit_cage . "', caddress= '" . $txt_edit_cadd . "', personToComplain = '" . $txt_edit_pname . "', page = '" . $txt_edit_page . "', paddress= '" . $txt_edit_padd . "', pcontact = '" . $txt_edit_pcontact . "', complaint = '" . $txt_edit_complaint . "', witness = '" . $txt_edit_witness . "', actionTaken= '" . $ddl_edit_acttaken . "', sStatus = '" . $ddl_edit_stat . "', locationOfIncidence= '" . $txt_edit_location . "'  where id = '" . $txt_id . "' ") or die('Error: ' . mysqli_error($con));

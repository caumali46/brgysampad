            ...
            <div style=" background: black;" >
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <p style="text-indent:40px;text-align: justify;">This is to certify that the person whose photo, signature and right thumb mark appear herein, is a resident of Barangay Sampad, Cardona, Rizal and that the person had requested a criminal check from this office following is/are our findings.</p>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                <p><b>
                                    ...
                                    ISSUED AT: <u>BARANGAY SAMPAD CARDONA RIZAL</u><br>
